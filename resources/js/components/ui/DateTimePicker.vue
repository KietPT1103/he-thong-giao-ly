...
const props = withDefaults(defineProps<{
    ...
    dateLabel: "Chọn ngày",
    timeLabel: "Chọn giờ",
    summaryLabel: "Thời gian đã chọn",
});
...
<template>
    <div class="date-time-picker">
        <section class="date-picker-calendar" :aria-label="dateLabel">
        ...
        <section class="time-picker-panel" :aria-label="timeLabel">
            <h3>Thời gian</h3>
            ...
            <div class="selected-time-summary" aria-live="polite"><Clock3 /><span><small>{{ summaryLabel }}</small><strong>{{ selectedLabel }}</strong></span></div>
        </section>
    </div>
</template>
...
.date-picker-navigation strong{font-size:16px}.date-picker-weekdays span{font-size:12px}.date-picker-days button{height:40px;font-size:13px}.today-button{font-size:13px}.time-picker-panel h3{font-size:13px}.time-column>span{font-size:12px}.time-option-list button,.time-list-shell :deep(.time-option-list button){font-size:14px}.selected-time-summary small{font-size:12px}.selected-time-summary strong{font-size:15px}@media(max-width:639px){.date-picker-navigation strong{font-size:15px}.date-picker-days button{height:38px}.time-option-list button,.time-list-shell :deep(.time-option-list button){font-size:13px}}
</style>
