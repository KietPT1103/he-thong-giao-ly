...
@media(min-width:1600px){.grading-page{gap:20px}.grading-toolbar{padding:14px 20px}.grading-workspace{grid-template-columns:380px minmax(0,1fr);min-height:max(680px,calc(100dvh - 270px))}.submission-filters{padding:16px}.submission-row{gap:11px;padding:14px 16px}.grading-detail>header{padding:22px 28px}.submission-files{padding:16px 28px}.answer-review{grid-template-columns:repeat(2,minmax(0,1fr));align-content:start;align-items:start;gap:16px;padding:22px 28px}.general-feedback{padding:22px 28px}.grading-detail>footer{padding:14px 28px}.grading-loading{grid-template-columns:380px 1fr;height:680px}}
