...
@media(min-width:1600px){.take-page{max-width:1220px;gap:22px}.assignment-intro{padding:44px 52px}.take-heading{padding:24px 28px}.take-heading h1{font-size:23px}.question-sheet{gap:18px}.take-question{padding:24px 28px}.take-question>header h2{max-width:76ch;font-size:16px}.take-options{gap:10px}.take-options label{padding:13px 15px}.take-options b{font-size:13px}.submission-attachments{padding:20px 24px}.take-footer{padding:14px 18px}}
@container child-assignment-take (max-width:52rem){.assignment-intro{padding-inline:24px}.assignment-intro dl{grid-template-columns:1fr 1fr}.assignment-intro dl>div:nth-child(3){border-left:0}.assignment-intro dl>div:nth-child(n+3){border-top:1px solid #e7edf5}.take-heading{padding:18px}.take-question{padding:18px 16px}.take-options{padding-left:0}}
@container child-assignment-take (max-width:40rem){.take-topbar{align-items:flex-start;flex-wrap:wrap}.save-indicator{padding-inline:12px}.assignment-intro{padding:25px 16px}.intro-copy h1{font-size:22px}.take-heading{align-items:stretch;flex-direction:column;padding:16px}.timer{justify-content:center}.take-question{padding:16px 13px}.take-options label{grid-template-columns:18px 26px minmax(0,1fr);padding:10px}.submission-attachments>header{align-items:stretch;flex-direction:column}.submission-attachments .ant-btn{min-height:44px;justify-content:center}.submission-attachments li{grid-template-columns:18px minmax(0,1fr) 30px}.submission-attachments li>span{display:none}.take-footer{bottom:6px;display:grid;grid-template-columns:1fr 1fr}.take-footer>div{grid-column:1/-1}.take-footer>.ant-btn{min-height:44px;justify-content:center}.take-state{align-items:flex-start;flex-direction:column}}
@container child-assignment-take (max-width:28rem){.assignment-intro dl{grid-template-columns:1fr}.assignment-intro dl>div+div{border-left:0;border-top:1px solid #e7edf5}.take-footer{grid-template-columns:1fr}.take-footer>div{grid-column:auto}.take-footer>.ant-btn{width:100%}}
@media(pointer:coarse){.take-topbar>.ant-btn,.assignment-intro>.ant-btn,.take-options label,.take-footer>.ant-btn{min-height:44px}}
